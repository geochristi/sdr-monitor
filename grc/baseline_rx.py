...
import baseline_rx_epy_block_0 as epy_block_0  # embedded python block
import baseline_rx_epy_block_1 as epy_block_1  # embedded python block
import sip



class baseline_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "baseline_rx")
        ...
        self._amp_range = qtgui.Range(0, 2, 0.05, 1, 200)
        ...
        self.epy_block_1 = epy_block_1.blk(threshold=threshold)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, amp, 0, 0)
...
def main(top_block_cls=baseline_rx, options=None):
